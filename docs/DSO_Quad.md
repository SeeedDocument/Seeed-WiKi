...
*   GCC port with FFT, spectrogram and various fixes [by pmos69 and marcosin](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=2957)

*   Alternative user interface [by gabonator1](http://www.seeedstudio.com/forum/viewtopic.php?f=10&amp;t=2362)

*   GCC port of the default firmware [by tmbinc](http://www.seeedstudio.com/forum/viewtopic.php?f=10&amp;t=2274)

*   Frequency response plotter [by jpa](http://www.seeedstudio.com/forum/viewtopic.php?f=10&amp;t=2485)

*   FFT example application [by gabonator1](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=2098)

*   Logic analyzer [by jpa](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=2861)

*   Pawn programming environment and various applications [by jpa](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=3239)

*   Port of SYS to gcc: [[1]](https://github.com/neilstockbridge/dsoquad-BIOS)

*   Tetris [by LinX](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=2344)
...
*   A 2D X-Y mode that plots the analog channels against each other on two axes with a digital channel optionally functioning as a "beam" enable/disable.
    *   [Something](http://www.seeedstudio.com/forum/viewtopic.php?f=22t=2458) seems to exist? Not in APP2.50 yet.
