...
category: MakerPro
bzurl: https://www.seeedstudio.com/g14-water-flow-sensor-p-1345.html?cPath=25_32
oldwikiname:  G14Wate_Sensor.jpg
prodimagename:  3wsp.JPG
surveyurl: https://www.research.net/r/G1_4_Water_Flow_Sensor
sku:     314150002
---
![](https://github.com/SeeedDocument/G1_4_Water_Flow_Sensor/raw/master/img/G14Wate_Sensor.jpg)
...
It has BSP thread. We have two kinds of water sensors. The black is standard(Thread major diameter) and the white one is smaller(Thread minor diameter). You can refer to [BSP details](http://en.wikipedia.org/wiki/British_standard_pipe_thread#Pipe_thread_sizes).
