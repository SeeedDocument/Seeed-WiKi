...
- Uses Standard 4-pin Grove Cables to connect to other Grove modules such as - [Grove Power Modules](http://wiki.seeed.cc/Grove/Grove_System/) and Grove - Base Shield
