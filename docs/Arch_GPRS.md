...
The cellular networking module on the Arch GPRS is based on the EG-10 [GPRS](http://en.wikipedia.org/wiki/General_Packet_Radio_Service) modem. With this, data collection functions can be performed easily using the 2G GSM based cellular network.
