...
Seeedstudio's official manual can be downloaded [here](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1929). I started this page as a project in my spare time to answer all the questions I had when I first got my DSO Quad.
...
*   [DSO Quad battery installation tutorial with video](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=2074)
...
</dd><dd> **Note:** There are [reports of reverse-polarity batteries.](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1911) _**This will destroy your charging circuit if not corrected.**_ Please carefully check for the proper alignment of red and black wires.
</dd></dl>
...
6.  If your battery was connected incorrectly, _**do not plug it in!**_ Go to [this forum thread](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1911) for help.
...
The DSO Quad is charged by connecting the USB cable. The LTC4054 battery controller [will not charge the battery](http://www.seeedstudio.com/forum/viewtopic.php?p=6922#p6922) while the power switch is on. This is best explained in a table:
...
<td> Powered on, [battery will not charge while on](http://www.seeedstudio.com/forum/viewtopic.php?p=6922#p6922)
</td></tr>
<tr>
<td> OFF
</td>
...
<td> [APP 2.34?](http://www.seeedstudio.com/forum/viewtopic.php?p=6760#p6760)

[SYS 1.32?](http://www.seeedstudio.com/forum/viewtopic.php?p=6760#p6760)
...
You might find more info on [http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1929](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1929).
...
Digital input bandwidth [This forum thread](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1978)
...
The DSO Quad firmware does a rapid USB disconnect-reconnect to do a "live" firmware update. This method is incompatible with Mac OS X or Linux. Please see [this forum thread](http://www.seeedstudio.com/forum/viewtopic.php?f=22&amp;t=1934) for more information.  See [DSO_Quad:Upgrading_Firmware#Linux](/DSO_Quad-Upgrading_Firmware#Linux "DSO Quad:Upgrading Firmware") for how to upgrade firmware from Linux.
