...
Here we will show you how this display works, please prepare materials as below to start.
...
Click on below button to download the library and install it, if you don't know how to install an Arduino library, please refer to the tutorial [(HOW TO INSTALL AN ARDUINO LIBRARY)](http://wiki.seeed.cc/Tutorial/How_to_Install_an_Arduino_Library/).
...
**Step1. **Insert the board to Seeeduino,

**Step2. **Connet your Seeeduino board with computer with an USB cable
...
If you have any question about how to start the uploading, please refer [here](http://wiki.seeed.cc/Platform/Arduino/SeeeduinoV4.2/#getting-started) to get more details.
...
The backlight is default on always, if you want to control the backlight, you need to do some hacking in the board. Please look at the back side of the board, there's a BACKLIGHT label, one side named ON the other side named D7. We need to cut the wire at ON side and solder D7 side. As shown below.
...
* [TFT Touch Shield Schematic.PDF](https://github.com/SeeedDocument/TFT_Touch_Shield_V2/raw/master/resources/TFT%20Touch.pdf)
